  ...
  return (
    <div className="py-16 bg-dark">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl md:text-5xl text-center mb-12">About <span className="text-teal">FlingPing.co</span></h1>
        ...
        <div className="flex flex-col md:flex-row items-center mb-20">
          <div className="md:w-1/2 md:pr-12 order-2 md:order-1">
            ...
            <p className="text-lg mb-4">FlingPing.co was born from a simple idea: what if we could make responsible sexual health as easy as sending a text? No awkward conversations, no forgotten names, no guesswork—just peace of mind.</p>
        ...
        <div className="flex flex-col md:flex-row items-center mb-20">
          ...
          <div className="md:w-1/2 md:pl-12">
            ...
            <p className="text-lg mb-4">We believe technology should work for you, not against you. That's why FlingPing.co uses anonymous, secure connections to keep you informed without compromising your privacy or dignity.</p>
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 md:pr-12 order-2 md:order-1">
            ...
            <p className="text-lg mb-4">FlingPing.co isn't just about technology—it's about creating a cultural shift where being proactive about sexual health becomes the norm.</p>
