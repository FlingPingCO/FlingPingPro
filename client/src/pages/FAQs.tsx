  ...
  const faqItems = [
    {
      ...
      answer: "<span className=\"inline-flex\"><span className=\"text-teal\">FlingPing</span><span className=\"text-coral\">.co</span></span> is your bold, secure partner in smarter sexual health. Designed to empower you with tools to stay informed and in control, it reimagines how technology can keep you ahead of the curve."
    },
    {
    ...
    },
    {
      ...
      answer: "That's the beauty of <span className=\"inline-flex\"><span className=\"text-teal\">FlingPing</span><span className=\"text-coral\">.co</span></span>—you don't need their number, name, or any personal information. The app creates anonymous connections through Bluetooth pairing, so you can stay informed without the awkward exchanges."
    },
    {
    ...
    },
    {
      ...
      answer: "We're limiting Founding Flinger membership to just 250 people. Once these spots are filled, the only way to access <span className=\"inline-flex\"><span className=\"text-teal\">FlingPing</span><span className=\"text-coral\">.co</span></span> will be through our regular subscription model."
    },
    {
    ...
    <div className="py-16 bg-dark">
      <div className="container mx-auto px-4">
        ...
        <p className="text-lg text-center mb-12 max-w-2xl mx-auto">
          Get answers to common questions about <span className="inline-flex"><span className="text-teal">FlingPing</span><span className="text-coral">.co</span></span>, our Founding Flinger program, 
