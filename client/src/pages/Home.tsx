    ...
    <>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center mb-12">
            <img src={womanWalkingDog} alt="Daily life with FlingPing" className="h-[180px] md:h-[360px] lg:h-[480px] object-contain" />
          </div>
                ...
                <div className="h-full">
                  <div className="bg-[#f4e9d9] rounded-3xl p-8 h-full flex flex-col">
                    ...
                    <div className="flex justify-center mt-6">
                      <img src={womanShopping} alt="Founding Flinger" className="h-[120px] md:h-[240px] object-contain" />
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center mb-12">
            <img src={deliveryDriver} alt="FlingPing delivers peace of mind" className="h-[180px] md:h-[360px] lg:h-[480px] object-contain" />
          </div>
      ...
      <section id="faq" className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center mb-12">
            <img src={collegeStudents} alt="Students using FlingPing" className="h-[180px] md:h-[360px] lg:h-[480px] object-contain" />
          </div>
