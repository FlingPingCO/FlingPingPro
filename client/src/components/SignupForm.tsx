        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex-grow">
            ...
            <div className="text-center text-xs sm:text-sm mt-3 sm:mt-4">
              <p className="mb-1 sm:mb-2">Secure payment via Stripe & PayPal</p>
              <div className="flex flex-wrap justify-center gap-1 sm:gap-2">
                ...
                {/* PayPal Logo */}
                <svg className="h-4 sm:h-6" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" aria-labelledby="paypal-label">
                  ...
                  <path d="M19.1 8.1c-.1-.1-.2-.1-.3-.1-.1 0-.2 0-.3-.1-.3-.1-.7-.1-1.1-.1h-3c-.1 0-.2 0-.2.1-.2.1-.3.2-.3.4l-.7 4.4v.1c0-.3.3-.5.6-.5h1.3c2.5 0 4.1-1 4.6-3.8v-.2c-.1-.1-.3-.2-.5-.2h-.1z" fill="#012169"/>
                </svg>
              </div>
            </div>
          </form>
