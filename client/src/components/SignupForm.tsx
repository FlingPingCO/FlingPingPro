...
const SignupForm = () => {
  ...
  return (
    <>
      <div className="bg-dark border-2 border-coral rounded-xl p-6 md:p-8">
        <div className="text-center mb-6">
          <h4 className="text-xl mb-2">Spots Are Limited!</h4>
          <div className="text-yellow text-lg font-bold">Only <span>250</span> Founding Flinger spots left</div>
        </div>
