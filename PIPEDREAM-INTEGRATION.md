...
2. Standard Content-Type header: `"Content-Type": "application/json"`
...
3. **Add processing steps** to your workflow:
   - Ensure your webhook trigger is configured to accept standard JSON payloads
   - No special authentication is needed as we're using the direct webhook URL
